...
class Gradients(QtWidgets.QWidget, GuiSaveBase):
    ...
    def connect_ui(self, update_func):
        ...
        self.x_weight_control.doubleValueChanged.connect(update_func)
        self.y_weight_control.doubleValueChanged.connect(update_func)
